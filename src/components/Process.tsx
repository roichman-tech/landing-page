              ...
              >
                ...
                <div className={`hidden md:flex ${index % 2 === 0 ? "md:order-2 justify-start pl-12" : "justify-end pr-12"}`}>
                  <div className="relative">
                    ...
                    <div className="absolute top-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-primary border-4 border-background shadow-sm hidden md:block" style={{ left: index % 2 === 0 ? "-2.5rem" : "auto", right: index % 2 === 1 ? "-2.5rem" : "auto" }} />
                  </div>
                </div>
